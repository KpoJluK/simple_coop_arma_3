mhq_class_name = "rhsusf_m1165a1_gmv_m134d_m240_socom_d";
...
//3
frendly_down_heli_from_third_mission = "RHS_AH64D"; //союзный подбитый вертолет
side_frendly_pilots = side (selectRandom allPlayers); //сторона пилотов которых нужно эвакуировать(не менять)
class_name_frendly_pilots = "rhsusf_army_ocp_helicrew"; //класс неймы союзных пилотов которых нужно эвакуировать
//4
...
//6
class_name_heli_pidbity_six_mission = selectRandom ["UK3CB_UH1H_Wreck", "Land_UH1H_Wreck_F", "BlackhawkWreck"]; // союзный транспортный побитый вертолет
